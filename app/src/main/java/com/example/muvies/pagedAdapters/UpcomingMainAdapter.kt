...
import kotlinx.android.synthetic.main.upcoming_main_list.view.*
...
class UpcomingMainAdapter: PagedListAdapter<UpcomingResult, UpcomingMainAdapter.UpcomingMainViewHolder>(diffUtilCallBack){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UpcomingMainViewHolder {
        return UpcomingMainViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.upcoming_main_list, parent, false))
    }
    ...
    inner class UpcomingMainViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        private var poster: ImageView = itemView.upcoming_main_image
        private var title: TextView = itemView.upcoming_main_text
